...
impl TaxonomyEngine {
    pub fn new() -> Self {
        let rules = vec![
            ...
            Rule { keyword: "808 kick", category: "Drums", value: "808 Kick" },
            Rule { keyword: "909 kick", category: "Drums", value: "909 Kick" },
            ...
            Rule { keyword: "hi-hat", category: "Drums", value: "Hi-Hat" },
            Rule { keyword: "open hat", category: "Drums", value: "Open Hat" },
            Rule { keyword: "closed hat", category: "Drums", value: "Closed Hat" },
            ...
            Rule { keyword: "splash", category: "Drums", value: "Splash" },
            Rule { keyword: "tom", category: "Drums", value: "Tom" },
            Rule { keyword: "rim", category: "Drums", value: "Rimshot" },
            Rule { keyword: "rimshot", category: "Drums", value: "Rimshot" },
            Rule { keyword: "drum fill", category: "Drums", value: "Fill" },
            Rule { keyword: "breakbeat", category: "Drums", value: "Break" },

            // 🪘 Percussion
            Rule { keyword: "perc", category: "Percussion", value: "Percussion" },
            Rule { keyword: "percussion", category: "Percussion", value: "Percussion" },
            Rule { keyword: "shaker", category: "Percussion", value: "Shaker" },
            Rule { keyword: "tamb", category: "Percussion", value: "Tambourine" },
            ...
            Rule { keyword: "djembe", category: "Percussion", value: "Djembe" },
            Rule { keyword: "cajon", category: "Percussion", value: "Cajon" },
            Rule { keyword: "tabla", category: "Percussion", value: "Tabla" },
            Rule { keyword: "cowbell", category: "Percussion", value: "Cowbell" },
            Rule { keyword: "triangle", category: "Percussion", value: "Triangle" },
            Rule { keyword: "tri", category: "Percussion", value: "Triangle" },
            Rule { keyword: "snap", category: "Percussion", value: "Snap" },
            Rule { keyword: "wood", category: "Percussion", value: "Wood" },
            Rule { keyword: "clave", category: "Percussion", value: "Clave" },
            Rule { keyword: "guiro", category: "Percussion", value: "Guiro" },
            ...
            Rule { keyword: "reese", category: "Bass", value: "Reese Bass" },
            Rule { keyword: "donk", category: "Bass", value: "Donk" },
            ...
            Rule { keyword: "pluck", category: "Synth", value: "Pluck" },
            Rule { keyword: "stab", category: "Synth", value: "Stab" },
            ...
            Rule { keyword: "rhodes", category: "Keys", value: "Rhodes" },

            // 🎻 Instrumente
            Rule { keyword: "guitar", category: "Guitar", value: "Guitar" },
            Rule { keyword: "acoustic guitar", category: "Guitar", value: "Acoustic Guitar" },
            Rule { keyword: "electric guitar", category: "Guitar", value: "Electric Guitar" },
            Rule { keyword: "brass", category: "Brass and Woodwinds", value: "Brass" },
            Rule { keyword: "flute", category: "Brass and Woodwinds", value: "Flute" },
            Rule { keyword: "sax", category: "Brass and Woodwinds", value: "Saxophone" },
            Rule { keyword: "string", category: "Strings", value: "Strings" },
            Rule { keyword: "violin", category: "Strings", value: "Violin" },
            ...
            Rule { keyword: "chant", category: "Vocals", value: "Chant" },
            Rule { keyword: "phrase", category: "Vocals", value: "Phrase" },
            Rule { keyword: "acapella", category: "Vocals", value: "Acapella" },
            ...
            Rule { keyword: "texture", category: "FX", value: "Texture" },
            Rule { keyword: "ambience", category: "FX", value: "Ambience" },
            Rule { keyword: "drone", category: "FX", value: "Drone" },
            Rule { keyword: "transition", category: "FX", value: "Transition" },
            ...
            Rule { keyword: "boom bap", category: "Genre", value: "Boom Bap" },
            ...
            Rule { keyword: "uk drill", category: "Genre", value: "UK Drill" },
            ...
            Rule { keyword: "riddim", category: "Genre", value: "Riddim" },
            Rule { keyword: "dnb", category: "Genre", value: "Drum & Bass" },
            Rule { keyword: "drum and bass", category: "Genre", value: "Drum & Bass" },
            Rule { keyword: "amapiano", category: "Genre", value: "Amapiano" },
            Rule { keyword: "afrobeat", category: "Genre", value: "Afrobeats" },
            Rule { keyword: "afrobeats", category: "Genre", value: "Afrobeats" },
            Rule { keyword: "reggaeton", category: "Genre", value: "Reggaeton" },
            Rule { keyword: "rnb", category: "Genre", value: "R&B" },
            Rule { keyword: "r&b", category: "Genre", value: "R&B" },
            Rule { keyword: "pop", category: "Genre", value: "Pop" },
            Rule { keyword: "baile", category: "Genre", value: "Baile Funk" },
            Rule { keyword: "baile funk", category: "Genre", value: "Baile Funk" },
            Rule { keyword: "jersey", category: "Genre", value: "Jersey Club" },
            Rule { keyword: "phonk", category: "Genre", value: "Phonk" },
            Rule { keyword: "country", category: "Genre", value: "Country" },
            Rule { keyword: "rock", category: "Genre", value: "Rock" },
            ...
            Rule { keyword: "soft", category: "Character", value: "Soft" },
            Rule { keyword: "hard", category: "Character", value: "Hard" },
            Rule { keyword: "dark", category: "Character", value: "Dark" },
            Rule { keyword: "bright", category: "Character", value: "Bright" },
            Rule { keyword: "warm", category: "Character", value: "Warm" },
            Rule { keyword: "cold", category: "Character", value: "Cold" },
            Rule { keyword: "analog", category: "Character", value: "Analog" },
            Rule { keyword: "digital", category: "Character", value: "Digital" },
            Rule { keyword: "gritty", category: "Character", value: "Gritty" },
            Rule { keyword: "saturated", category: "Character", value: "Saturated" },
        ];
    ...
    pub fn analyze(&self, path: &Path, duration_ms: i64) -> Vec<serde_json::Value> {
        ...
        let is_cymbal_or_fx = path_str.contains("crash") || path_str.contains("ride") ||
            ...
            path_str.contains("pad") || path_str.contains("808");
        ...
        // ==========================================
        let broad_classes = vec!["Drums", "Percussion", "Bass", "Synth", "Keys", "Guitar", "Strings", "Brass and Woodwinds", "Vocals", "FX"];
        ...
        tags_vec.sort_by(|a, b| {
            ...
            fn get_prio(cat: &str, val: &str) -> i32 {
                if cat == val { return 1; } // 1. Platz: Hauptklassen (z.B. "Drums", "Percussion")

                match cat {
                    "Drums" | "Percussion" | "Bass" | "Synth" | "Keys" | "Guitar" | "Strings" | "Vocals" | "Brass and Woodwinds" | "FX" => 2, // 2. Platz: Spezifische Instrumente (z.B. "Kick", "Snare")
